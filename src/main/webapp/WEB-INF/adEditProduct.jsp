<%-- 
    Document   : adEditProduct
    Created on : Oct 25, 2024, 7:27:07 PM
    ...
    <body>
        ...
        <div id="editModal" class="modal-container">
            <div class="modal-box">
                ...
                <div class="form">
                    <form action="Product?action=edit&id=${product.productId}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="top-left">
                            ...
                            <input type="text" id="productName" value="${product.productName}" name="productName"><br>

                            <div class="top-left--inner">
                                <div class="top-left--inner-slt">
                                    <label for="brand">Brand:</label>
                                    <select id="brand" name="brand" style="padding: .2rem .8rem;">
                                        <option value="${product.brand}">${product.brand}</option>
                                        <c:forEach items="${brands}" var="b">
                                            <c:if test="${product.brand != b.brandName}">
                                ...
                                <div class="top-left--inner-slt">
                                    ...
                                    <select id="type" name="type" style="padding: .2rem .8rem;">
                                        <option value="${product.type}">${product.type}</option>
                                        <c:forEach items="${types}" var="t">
                                            <c:if test="${product.type != t.type}">
                        ...
                        <div class="top-right">
                            ...
                            <input type="number" id="countInStock" value="${product.countInStock}" name="countInStock" min="0"><br>
                            <label for="price">Price:</label>
                            <input type="number" step="0.01" id="price" name="price" value="${product.price}"><br>
                            <input type="hidden" id="selled" name="selled" value="${product.selled}"><br>
                        </div>                             
                        ...
                        <div class="center-bottom">
                            ...
                            <div class="image_input">
                                ...
                                <input type="file" id="image" name="image" accept="image/*"  multiple hidden><br>
