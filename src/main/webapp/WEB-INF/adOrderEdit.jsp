<%-- 
    Document   : adOrderEdit
    Created on : Nov 4, 2024, 10:21:18 AM
                ...
                <div class="form">
                    <form action="Order?action=edit" method="post">
                        ...
                        <div class="top-left">
                            ...
                            <input type="text" id="customerName" value="${order.productName}" readonly><br>

                            <label for="productName">Product Name:</label>
                            <input type="text" id="productName" value="${order.customerName}" readonly><br>

                            <label for="phone">Phone:</label>
                            <input type="text" id="phone" name="phone" value="${order.phone}" readonly><br>

                            <label for="email">Email:</label>
                            <input type="email" id="email" name="email" value="${order.email}" readonly><br>

                            <label for="orderDate">Order Date:</label>
                            <input type="text" id="orderDate" name="orderDate" value="${order.orderDate}" readonly><br>
                        </div>

                        <div class="top-right">
                            <!-- Editable fields -->
                            <label for="street">Street:</label>
                            <input type="text" id="street" name="street" value="${order.street}" placeholder="Street"><br>

                            <label for="ward">Ward:</label>
                            <input type="text" id="ward" name="ward" value="${order.ward}" placeholder="Ward"><br>

                            <label for="district">District:</label>
                            <input type="text" id="district" name="district" value="${order.district}" placeholder="District"><br>

                            <label for="city">City:</label>
                            <input type="text" id="city" name="city" value="${order.city}" placeholder="City"><br>

                            <label for="country">Country:</label>
                            <input type="text" id="country" name="country" value="${order.country}" placeholder="Country"><br>

                            <label for="status">Status:</label>
                            <input type="text" id="status" name="status" value="${order.status}" placeholder="Status"><br>
                        </div>

                        <!-- Save Button -->
                        <button type="submit" class="submit-btn" onclick="location.href = 'Order'">
                            Save Changes
                        </button>

                        <!-- Close Button -->
                        <button type="button" class="close-btn" onclick="location.href = 'Order'">
                            Close
                        </button>
                    </form>
                </div>
