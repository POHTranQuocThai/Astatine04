        ...
        <main class="table">
            ...
            <div id="editModal" class="modal-container">
                <div class="modal-box"> 
                    ...
                    <div class="form">
                        <form action="Profile?action=password" method="post">
                            ...
                            <div class="top-left">
                                ...
                                <div class="input-password">
                                    ...
                                    <i class="bi bi-eye-slash-fill" id="eyeicon-old" style="font-size: 1.2rem; cursor: pointer"
                                       onclick="togglePasswordVisibility('old-password', 'eyeicon-old')"></i>
                                </div>
                            </div>
                            ...
                            <div class="top-right">
                                ...
                                <div class="input-password">
                                    ...
                                    <i class="bi bi-eye-slash-fill" id="eyeicon-new" style="font-size: 1.2rem; cursor: pointer"
                                       onclick="togglePasswordVisibility('new-password', 'eyeicon-new')"></i>
                                </div>
                                ...
                                <div class="input-password">
                                    ...
                                    <i class="bi bi-eye-slash-fill" id="eyeicon-confirm" style="font-size: 1.2rem; cursor: pointer"
                                       onclick="togglePasswordVisibility('confirm-password', 'eyeicon-confirm')"></i>
                                </div>
                            </div>
