<%-- 
    ...
    Created on : Oct 27, 2024, 1:09:19 AM
        ...
        <div id="editModal" class="modal-container">
            <div class="modal-box">
                ...
                <form action="User?action=delete" method="post">
                    ...
                    <div>
                        <p style="font-size: 1.5rem;">Do you want to delete <span style="font-weight: 500; color: #21A691">${user.fullname}</span>?</p>
                    </div>
                    ...
                    <div class="center-bottom-delete">
                        ...
                        <!-- Close Button -->
                        <button type="button" class="close-btn" onclick="location.href = 'User'">
                            Close
                        </button>
                    </div>
                </form>
