        ...
        <main class="table">
            ...
            <section class="table_body">
                <div class="create-btn">
                    <a href = 'Transport?action=create' class="create-btn--inner">
                ...
                <table>
                    ...
                    <tbody>
                        <c:forEach items="${transportList}" var="list">
                            <tr>
                                <td>${list.transportId} </td>
                                <td>${list.transportName}</td>
                                <td>${list.description}</td>
                                <td>
                                    <!-- Edit Icon Button -->
                                    <a href = 'Transport?action=edit&id=${list.transportId}' class="table-btn" style="text-decoration: none;">
                                    ...
                                    <!-- Delete Icon -->
                                    <a href = 'Transport?action=delete&id=${list.transportId}' class="table-btn" style="text-decoration: none;">
                                        <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#5f6368">
