<%-- 
    Document   : adCreateProduct
    Created on : Oct 26, 2024, 12:42:03 AM
...
<html>
                ...
                <div class="form">
                    <form id="productForm" action="Product?action=create" method="post" enctype="multipart/form-data">
                        ...
                        <div class="top-left">
                            ...
                            <input type="text" id="productName" value="${product.productName}" name="productName" required><br>

                            <div class="top-left--inner">
                                <div class="top-left--inner-slt">
                                    <label for="brand">Brand:</label>
                                    <select id="brand" name="brand" style="padding: .2rem .8rem;" required>
                                ...
                                <div class="top-left--inner-slt">
                                    ...
                                    <select id="type" name="type" style="padding: .2rem .8rem;" required>
                        ...
                        <div class="top-right">
                            ...
                            <input type="number" step="1" id="countInStock" name="countInStock" min="0"><br>
    ...
    <!-- JS Link-->
    <script type="text/javascript" src="./assets/js/JSRemake/adminImage" defer></script>
