<%-- 
    Document   : adDeleteUser
    Created on : Oct 27, 2024, 12:24:25 AM
    ...
    <body>
        ...
        <div id="editModal" class="modal-container">
            <div class="modal-box">
                ...
                <form action="Transport?action=delete&id=${transport.transportId}" method="post">
                    <input type="hidden" name="id" value="${transport.transportId}">
                    <div class="center-bottom">
                        <p style="font-size: 1.5rem;">Do you want to delete <span style="font-weight: 500; color: #21A691">${transport.transportName}</span>?</p>
                    </div>
